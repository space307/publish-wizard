...
exports.askAboutNewVersion = async ({ availablePostfixes }) =>
  await inquirer.prompt([
    { type: 'list', message: 'Select postfix', name: 'postfix', choices: availablePostfixes },
    { type: 'list', message: 'Select an extent of changes', name: 'extent', choices: ['patch', 'minor', 'major'] },
  ]);
